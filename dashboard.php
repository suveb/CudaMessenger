<?php
    ...
    $posts = "SELECT o.pageid,o.postid,p.name,o.datecreated,o.content FROM pages p, post o WHERE p.pageid = o.pageid AND p.pageid IN (SELECT p1.pageid FROM pages p1,follows f WHERE p.pageid = f.pageid AND f.userid = $userid) ORDER BY o.datecreated DESC";
